  ...
  return (
    <div className="container flex mx-auto max-w-screen-md items-center h-screen">
      ...
      <div className="flex flex-col w-2/5">
        <div className="flex flex-col items-cenet bg-white p-4 rounded border border-gray-primary mb-4">
          <h1 className="flex justify-center w-full">
            <img src="/images/logo.png" alt="Instagram" className="flex-col w-6/12" />
          </h1>
